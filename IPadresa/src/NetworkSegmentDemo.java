...
public class NetworkSegmentDemo {
	...
	public static boolean isMaskValid(String mask) {
		String correctMask = "(255\\.255\\.255\\.(255|254|252|248|240|224|192|128))|"
	...
	public static boolean isIPAdressValid(String ipAdress) {
		String correctMask = "([01]?\\d\\d?|2[0-4]\\d|25[0-5])\\." + "([01]?\\d\\d?|2[0-4]\\d|25[0-5])\\."
	...
	public static void main(String[] args) {
		...
		String[] maskArray = { "255.255.255.254", "255.255.255.253", "255.255.255.252", "255.0.0.0", "255.255.0.0",
				"255.255.20.254", "255.255.255.128" };

		String[] ipAdressArray = { "255.255.255.255", "0.0.255.253", "255.255.1", "255.0.0.1", "255.255..0.0",
				"123.255.20.254", };
		...
		// metoda ktora my spravila bitovy sucin medzi adresou a maskou , a
		// vratila mi vysledok ako pole Integerov
		...
		for (String mask1 : maskArray)
			System.out.println("Je maska " + mask1 + " validna? " + isMaskValid(mask1));// validator
																						// masky

		System.out.println();

		for (String ipAdress : ipAdressArray)
			System.out.println("Je IPadressa " + ipAdress + " validna? " + isIPAdressValid(ipAdress));// validator
																										// masky
	}
}
